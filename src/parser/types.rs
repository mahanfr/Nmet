...
impl VariableType {
    ...
    pub fn binary_cast(&self, other: &Self) -> Result<Self, String> {
        ...
        match cmp {
            ...
            (Self::Int | Self::UInt, Self::Char) | (Self::Char, Self::UInt | Self::Int) => {
                Ok(Self::Pointer)
            }
            _ => Err(format!(
    ...
    pub fn is_numeric(&self) -> bool {
        matches!(
            self,
            VariableType::Int | VariableType::Char | VariableType::UInt | VariableType::Pointer
        )
    }
}
